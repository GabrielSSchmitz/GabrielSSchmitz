...
    <img src="https://img.shields.io/badge/Microsserviços-2C3E50?style=for-the-badge&logo=microservices&logoColor=white" alt="Microsserviços Badge"/>
</p>
...
| **Frontend** | **Angular** (Framework de ponta), **Javascript/Typescript**, **Node.js** (para BFF's e GATEWAY) |
...
* **Saúde Pública:** Experiência no desenvolvimento de sistemas vitais como **Lista de Espera SUS**, **Agenda Cirúrgica** e gestão de **Leitos**, impactando diretamente a vida dos cidadãos.
* **Plataformas de Gestão Estratégica:** Colaborei em projetos de grande escala como **Conecta** e **Guardião**.
...
* **Excelência em Code Review:** Realizo **code reviews** detalhados com foco em performance, segurança e aderência a boas práticas, transformando-os em momentos de aprendizado e crescimento para a equipe.
...
| Plataforma | Link |
| :--- | :--- |
| **LinkedIn** | [linkedin.com/in/gabriel-schmitz-80436788](https://www.linkedin.com/in/gabriel-schmitz-80436788/) |
| **GitHub** | [github.com/GabrielSSchmitz](https://github.com/GabrielSSchmitz) |
